                        ...
                        <ul className="dropdownMenu">
                            ...
                            <li style={{ padding: "10px 0" }} className={dropdowns['bankaccounts']? `withDropdown open` : `withDropdown`}>
                                ...
                                <ul className="dropdownMenu">
                                    ...
                                    <li><div><Link href="/globalBanking/bank-accounts/docs#add-exchange-rates" onClick={() => handleClick('add-exchange-rates')} className={clicked['add-exchange-rates'] ? `clicked` : ``}><div className="method-side get">GET</div><div className='api-div'><p>Add exchange rates</p></div></Link></div></li>
