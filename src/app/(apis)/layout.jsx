                    ...
                    <li style={{padding:"10px 0"}} className={dropdowns['globalBanking'] ? `withDropdown open` : `withDropdown`}>
                        ...
                        <ul className="dropdownMenu">
                            ...
                            <li style={{ padding: "10px 0" }} className={dropdowns['bankaccounts']? `withDropdown open` : `withDropdown`}>
                                ...
                                <ul className="dropdownMenu">
                                    <li><Link href="/globalBanking/bank-accounts/docs" onClick={() => handleClick('auth')} className={clicked['auth'] ? `clicked` : ``}>Bank accounts</Link></li>
                                    ...
                                    <li><div><Link href="/globalBanking/bank-accounts/docs#delete-bank" onClick={() => handleClick('all-bank-admins')} className={clicked['all-bank-admins'] ? `clicked` : ``}><div className="method-side get">GET</div><div className='api-div'><p>Get all bank admins</p></div></Link></div></li>
                                    ...
                                    <li><div><Link href="/globalBanking/bank-accounts/docs#user-card-applications" onClick={() => handleClick('card-applications')} className={clicked['card-applications'] ? `clicked` : ``}><div className="method-side get">GET</div><div className='api-div'><p>Get all card applications</p></div></Link></div></li>
